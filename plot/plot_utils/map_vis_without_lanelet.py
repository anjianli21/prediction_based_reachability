...
from plot.plot_utils import dict_utils
...
def draw_map_without_lanelet(filename, axes, lat_origin, lon_origin):
    ...
    # axes.patch.set_facecolor('white')  # Change background to be white
    ...
    for way in e.findall('way'):
        ...
        elif way_type == "curbstone": # included in the map
        ...
        elif way_type == "pedestrian_marking": # included in the map
        ...
        elif way_type == "virtual": # virtual trajectory, included in the map
            # type_dict = dict(color="blue", linewidth=1, zorder=10, dashes=[2, 5]) # Don't show virtual in our map
            continue
