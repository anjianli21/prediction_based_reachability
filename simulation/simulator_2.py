...
class Simulator2(object):
    ...
    def simulate(self):
        ...
        x_h_init, y_h_init, psi_h_init, v_h_init = human_car_traj['x_t'][human_start_step], human_car_traj['y_t'][
            human_start_step], human_car_traj['psi_t'][human_start_step], human_car_traj['v_t'][human_start_step]
    ...
    def get_traj_from_prediction(self, filename):
        ...
        if self.scenario == "roundabout":
            traj_file_name = self.file_dir_roundabout_new + '/' + filename
        else:
            traj_file_name = ""
